		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					...
					<input type="text" name="nic" id="nic" class="form-control" value="<?php echo isset($meta['nic']) ? $meta['nic']: '' ?>" required  autocomplete="off">
				</div>
				<div class="form-group col-6">
				...
				<div class="form-group col-6">
					...
					<select name="type" id="type" class="custom-select">
						...
						<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Non-staff</option>
					</select>
				</div>
				<div class="form-group col-6">
					<label for="location_id">Vaccination Branch</label>
