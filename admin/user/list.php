        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped">
				...
				<tbody>
					<?php 
						$i = 1;
						$location_qry = $conn->query("SELECT * FROM vaccination_location_list");
						$result = $location_qry->fetch_all(MYSQLI_ASSOC);
						$location_arr = array_column($result,'location','id');
					...
					?>
						<tr>
							...
							<td ><p class="m-0 truncate-1"><?php echo $row['nic'] ?></p></td>
							...
							<td><?php echo ($row['type'] == 1) ? 'Staff' : 'Non-staff' ?></td>
							<td align="center">
